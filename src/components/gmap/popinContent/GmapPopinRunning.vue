<template>
  <div class="bg-lightgray px-4 py-3">
    <span>Unit Name:</span>
    <span class="ml-2 font-bold">{{ props.unit_name }}</span>
  </div>
    ...
    <div class="space-y-3">
      <div class="flex items-center justify-between">
        ...
        <p class="text-blue font-bold">
          <KmhOrMph :value="props.vehicle_speed" />
        </p>
      </div>
      <div class="flex items-center justify-between">
        <p>Posted Speed Limit:</p>
        <p>
          <KmhOrMph :value="props.posted_speed_limit" />
        </p>
      </div>
      <div class="flex items-center justify-between">
        <p>Allowed Speed Limit:</p>
        <p>
          <KmhOrMph :value="props.allowed_speed" />
        </p>
      </div>
      <div class="flex items-center justify-between">
        <p>Active:</p>
