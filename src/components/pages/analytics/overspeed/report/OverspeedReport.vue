  ...
  <div v-if="!loading" class="w-full flex flex-col relative">
    ...
    <table class="flex-1 table-auto w-full mb-4 rounded-xl overflow-hidden">
      <thead class="bg-gray-500">
        <tr>
          <th scope="col" class="border-r-1 border-gray w-[175px]">
          ...
          <th scope="col" class="border-r-1 border-gray w-[150px]">
            <div class="header__item">
      ...
      <tbody class="relative">
        ...
        <tr v-if="!reportOverspeeds.length">
          <span>{{ t(`main_toolbar.no data available`) }}</span>
        </tr>
      </tbody>
    </table>
...
const downloadCSV = () => {
  exportCSV(
    reportOverspeeds.value.map((o) => {
      ...
      return {
        ...o,
        position: `${o.position.lat};${o.position.long}`,
      };
    }),
